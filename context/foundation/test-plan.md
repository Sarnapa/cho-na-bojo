...
|---|------------|-----------------|----------------|------------|--------|---------------|
| 1 | Transactional critical-path foundation | Bootstrap the runner and prove capacity and privacy invariants at the API/database boundary | #1, #2 | unit + real-database integration | complete | testing-transactional-critical-path-foundation |
