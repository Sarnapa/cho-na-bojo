...
|---|---|---|---|---|
| F-01 | data-layer-foundation | Foundation: Supabase Postgres + migrations + seeded sports & Warsaw venues | yes | Prepared — implementation plan ready; next: `/10x-implement data-layer-foundation` |
