...
| S-07 | event-lifecycle-ops | cancel my own event (participants get a push), remove a participant (participant gets a push), leave an event as a participant (organizer gets a push); past-end events are auto-closed | S-06 | FR-012, FR-013, FR-014 | done |
...
| S-07 | event-lifecycle-ops | Cancel event, remove participant, leave event, auto-close past events | yes | Done |
...
- **S-07: cancel my own event (participants get a push), remove a participant (participant gets a push), leave an event as a participant (organizer gets a push); past-end events are auto-closed** — Archived 2026-09-12 → `context/archive/2026-09-11-event-lifecycle-ops/`. Lesson: —.
