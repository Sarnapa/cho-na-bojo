...
- [x] 4.1 Solution builds — 95adbbf
- [x] 4.2 AddPushOutbox migration applies cleanly — 95adbbf

#### Manual

- [x] 4.3 Join request creates exactly one organizer-addressed outbox row — 95adbbf
- [x] 4.4 Identical repeat request creates no additional row — 95adbbf
- [x] 4.5 Accept creates one requester-addressed row; repeat accept creates none — 95adbbf
- [x] 4.6 Reject creates one requester-addressed row — 95adbbf
- [x] 4.7 Auto-accept join creates one organizer row and none for the requester — 95adbbf
- [x] 4.8 Failed join (capacity or ended event) creates no row and response is unchanged — 95adbbf
...
- [x] 7.1 Solution builds — 5f83118
- [x] 7.2 Deployed API /health returns healthy with Firebase variables set — 5f83118
