...
- [x] 2.1 Solution builds — 1ca0716
- [x] 2.2 Migration applies cleanly — 1ca0716
- [x] 2.3 No pending model changes — 1ca0716
- [x] 2.4 Both new routes appear in the OpenAPI document — 1ca0716
- [x] 2.5 Accept/reject HTTP checks: 200 organizer, 404 non-organizer, 409 already-resolved, 404 fabricated id — 1ca0716

#### Manual

- [x] 2.6 B requests, A accepts, B's card shows "Joined" after refresh — 1ca0716
- [x] 2.7 A rejects C; C's card shows rejected and re-tapping Join replays the rejection — 1ca0716
- [x] 2.8 Auto-accept event accepts the request immediately with no organizer action — 1ca0716
- [x] 2.9 Full event refuses further accepts and leaves pending requests pending — 1ca0716
...
- [x] 4.1 Solution builds — 1b14b50
- [x] 4.2 Android app builds — 1b14b50
- [x] 4.3 No hardcoded colors or off-grid spacing in the new XAML — 1b14b50

#### Manual

- [x] 4.4 Two tabs render; map, venue sheet, and venue-events modal all still work — 1b14b50
- [x] 4.5 Organizer sees an accurate pending badge and opens the request queue — 1b14b50
- [x] 4.6 Accept increments the count; reject confirms first, then resolves the row — 1b14b50
- [x] 4.7 Double-tapping Accept produces no duplicate action or error — 1b14b50
- [x] 4.8 Participant sees correct statuses and the locked contact state — 1b14b50
- [x] 4.9 Network loss mid-accept produces a retryable message, not a crash or wrong state — 1b14b50
- [x] 4.10 An empty account sees the empty state — 1b14b50
